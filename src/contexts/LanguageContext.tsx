...
const translations: Translations = {
  ...
  // Auth additional
  "auth.forgot_password": { pt: "Esqueci minha senha", en: "Forgot my password" },
  "auth.forgot_password_sent": { pt: "Solicitação Enviada", en: "Request Sent" },
  "auth.forgot_password_desc": { pt: "Se o email existir, um administrador irá aprovar sua solicitação de troca de senha.", en: "If the email exists, an administrator will approve your password reset request." },
  "auth.forgot_password_instructions": { pt: "Digite seu email para solicitar a troca de senha. Um administrador irá aprovar sua solicitação.", en: "Enter your email to request a password reset. An administrator will approve your request." },
  "auth.enter_email": { pt: "Digite seu email primeiro", en: "Enter your email first" },
  "auth.send_request": { pt: "Enviar Solicitação", en: "Send Request" },
  "auth.sending": { pt: "Enviando...", en: "Sending..." },

  // Campaign Detail
  "campaign.paused": { pt: "Campanha pausada", en: "Campaign paused" },
  "campaign.activated": { pt: "Campanha ativada", en: "Campaign activated" },
  "campaign.error_update_status": { pt: "Erro ao atualizar status", en: "Error updating status" },
  "campaign.video_removed": { pt: "Vídeo removido do ranking", en: "Video removed from ranking" },
  "campaign.error_remove_video": { pt: "Erro ao remover vídeo", en: "Error removing video" },
  "campaign.metrics_updated": { pt: "Métricas atualizadas!", en: "Metrics updated!" },
  "campaign.error_sync_metrics": { pt: "Erro ao sincronizar métricas", en: "Error syncing metrics" },
  "campaign.videos_updated": { pt: "vídeo(s) atualizados", en: "video(s) updated" },
  "campaign.invalid_links": { pt: "link(s) inválidos", en: "invalid link(s)" },
  "campaign.videos_error": { pt: "vídeo(s) com erro", en: "video(s) with error" },
  "campaign.participant": { pt: "Participante", en: "Participant" },
  "campaign.error_loading": { pt: "Erro ao carregar campanha", en: "Error loading campaign" },
  "campaign.not_found": { pt: "Campanha não encontrada", en: "Campaign not found" },
  "campaign.back_to_campaigns": { pt: "Voltar para Campanhas", en: "Back to Campaigns" },
  "campaign.active_status": { pt: "Ativa", en: "Active" },
  "campaign.ended_status": { pt: "Encerrada", en: "Ended" },
  "campaign.total_views": { pt: "Views Totais", en: "Total Views" },
  "campaign.recognized_videos": { pt: "Vídeos Reconhecidos", en: "Recognized Videos" },
  "campaign.about": { pt: "Sobre a Campanha", en: "About the Campaign" },
  "campaign.prizes": { pt: "Prêmios", en: "Prizes" },
  "campaign.sync_all": { pt: "Sincronizar Todos", en: "Sync All" },
  "campaign.syncing": { pt: "Sincronizando...", en: "Syncing..." },
  "campaign.video_ranking": { pt: "Ranking de Vídeos", en: "Video Ranking" },
  "campaign.no_videos": { pt: "Nenhum vídeo encontrado", en: "No videos found" },
  "campaign.no_videos_desc": { pt: "Os vídeos submetidos aparecerão aqui.", en: "Submitted videos will appear here." },
  "campaign.confirm_remove": { pt: "Remover vídeo?", en: "Remove video?" },
  "campaign.confirm_remove_desc": { pt: "Esta ação não pode ser desfeita.", en: "This action cannot be undone." },
  "campaign.profile_url_not_allowed": { pt: "URLs de perfil não são permitidas", en: "Profile URLs are not allowed" },

  // Submit Video Modal
  "submit.no_videos_found": { pt: "Nenhum vídeo encontrado. Sincronize a conta primeiro.", en: "No videos found. Sync the account first." },
  "submit.all_videos_registered": { pt: "Todos os vídeos já estão cadastrados nesta campanha.", en: "All videos are already registered in this campaign." },
  "submit.videos_imported": { pt: "vídeo(s) importado(s)", en: "video(s) imported" },
  "submit.already_registered": { pt: "já cadastrados", en: "already registered" },
  "submit.error_import": { pt: "Erro ao importar vídeos", en: "Error importing videos" },
  "submit.will_be_validated": { pt: "Será validado manualmente", en: "Will be validated manually" },
  "submit.video_belongs_to": { pt: "Vídeo pertence a", en: "Video belongs to" },
  "submit.videos_sent": { pt: "vídeo(s) enviado(s) com sucesso!", en: "video(s) sent successfully!" },
  "submit.error_send": { pt: "Erro ao enviar vídeos", en: "Error sending videos" },
  "submit.select_campaign_platform": { pt: "Selecione campanha e plataforma", en: "Select campaign and platform" },
  "submit.add_valid_link": { pt: "Adicione pelo menos um link válido", en: "Add at least one valid link" },
  "submit.fix_invalid_links": { pt: "Corrija os links inválidos antes de enviar", en: "Fix invalid links before sending" },
  "submit.no_approved_campaign": { pt: "Nenhuma campanha aprovada", en: "No approved campaign" },
  "submit.no_account": { pt: "Sem conta", en: "No account" },
  "submit.links": { pt: "Links", en: "Links" },
  "submit.import": { pt: "Importar", en: "Import" },
  "submit.select_account": { pt: "Selecione a conta", en: "Select account" },
  "submit.choose_account": { pt: "Escolha uma conta", en: "Choose an account" },
  "submit.import_all_videos": { pt: "Importar Todos os Vídeos", en: "Import All Videos" },
  "submit.importing": { pt: "Importando...", en: "Importing..." },
  "submit.ready_to_send": { pt: "pronto(s) para enviar", en: "ready to send" },
  "submit.link_placeholder": { pt: "Link do vídeo", en: "Video link" },
  "submit.add_link": { pt: "Adicionar link", en: "Add link" },
  "submit.sending": { pt: "Enviando...", en: "Sending..." },
  "submit.send_videos": { pt: "Enviar Vídeos", en: "Send Videos" },

  // Dashboard Client
  "dashboard.no_campaigns_found": { pt: "Nenhuma Campanha Encontrada", en: "No Campaigns Found" },
  "dashboard.no_campaigns_desc": { pt: "Você ainda não possui campanhas. Crie uma campanha para começar a acompanhar o desempenho dos seus clippers.", en: "You don't have any campaigns yet. Create a campaign to start tracking your clippers' performance." },
  "dashboard.manage_campaigns": { pt: "Gerenciar Campanhas", en: "Manage Campaigns" },
  "dashboard.client_title": { pt: "Dashboard do Cliente", en: "Client Dashboard" },
